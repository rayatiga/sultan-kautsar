    ...
    project.innerHTML += `<div class="col-md-6 col-lg-6 mb-4">
                            <div class="card border-dark shadow-sm h-100">
                              ...
                              <div class="card-footer">
                                <a onclick="alert('Sorry, ${projects[i].name} is not available right now.')" href="${projects[i].link}" rel="nofollow noopener noreferrer" class="text-decoration-none link-dark small float-end">Visit Website <i class="bi bi-box-arrow-up-right"></i></a>
                              </div>
                            </div>`
  }
}
