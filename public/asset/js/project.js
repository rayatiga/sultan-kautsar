        ...
        project.innerHTML += `<div class="col-lg-6 mb-4">
            <div class="card bg-light border-dark shadow h-100">
                ...
                <div class="card-footer">
                    <a href="${projectList[i].link}" target="_blank" rel="nofollow noopener noreferrer" class="text-decoration-none link-dark small float-end">Visit Website <i class="bi bi-box-arrow-up-right"></i></a>
                </div>
            </div>`
    }
}
